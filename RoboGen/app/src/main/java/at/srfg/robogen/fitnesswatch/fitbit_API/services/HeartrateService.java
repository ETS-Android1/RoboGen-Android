...
public class HeartrateService {
    ...
    private final static String DEVICE_URL = "https://api.fitbit.com/1/user/-/activities/heart/date/today/1d.json";
    //private final static String DEVICE_URL = "https://api.fitbit.com/1/user/-/activities/heart/date/today/today/1min.json";
    private static final ResourceLoaderFactory<HeartContainer> HEARTRATE_LOADER_FACTORY = new ResourceLoaderFactory<>(DEVICE_URL, HeartContainer.class);
