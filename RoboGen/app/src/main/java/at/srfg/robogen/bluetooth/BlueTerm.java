...
*/                
    ...
    private boolean handleDPad(int keyCode, boolean down) {
        ...
        if (down) {
            if (keyCode == KeyEvent.KEYCODE_DPAD_CENTER) {
            	...
            	buffer[0] = 27; // ESC
            	mSerialService.write( buffer );                    
                //if (mEmulatorView.getKeypadApplicationMode()) { // TODO: still needed?
                	buffer[0] = 'O';
                	mSerialService.write( buffer );                    
                //} else {
                	//buffer[0] = '[';
                	//mSerialService.write( buffer );         // TODO: still needed?
                //}
            	buffer[0] = (byte)code;
            	mSerialService.write( buffer );                    
            }
    ...
    //private void doDocumentKeys() {  // TODO: is this still needed?
...
*/
    ...
    public EmulatorView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //TypedArray a = context.obtainStyledAttributes(R.styleable.EmulatorView); // TODO: is this still needed?
